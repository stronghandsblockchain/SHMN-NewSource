#!/bin/sh
# Copyright (c) 2017-2019 The Bitcoin Core developers & 2021 SHMN Developers
...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the shmn repository."
  exit 1
fi
...
echo 'When compiling shmnd, run `./configure` in the following way:'
echo
